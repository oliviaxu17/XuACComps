...
```{r, include = FALSE}
# Reading in text files, see TwainAnalysis.Rmd for full data 
# collection and cleaning process
roughingittext <- read.table("roughingit.txt", sep = "\t")
innocentstext <- read.table("innocents.txt", sep ="\t")
tomsawyertext <- read.table("tomsawyer.txt", sep ="\t")
huckfinntext <- read.table("huckfinn.txt", sep = "\t")
connyankeetext <- read.table("connyankee.txt", sep = "\t")
puddtext <- read.table("pudd.txt", sep="\t")
```
